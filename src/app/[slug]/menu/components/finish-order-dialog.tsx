...
import { emailSchema } from '../helpers/email';
  ...
  interface finishOrderDialogIsIpenProps{
    open: boolean;
    onOpenChange: (open: boolean) => void;
  }

const FinishOrderDialog = ({open, onOpenChange}: finishOrderDialogIsIpenProps) => {
...
<FormField
        ...
        />
    <DrawerFooter>
      <Button type="submit" className="rounded-full" variant="destructive">Finalizar</Button>
      <DrawerClose asChild>
